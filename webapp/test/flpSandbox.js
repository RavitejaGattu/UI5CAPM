		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#xomcomcmmssapui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"xomcomcmmssapui-display": {
								"semanticObject": "xomcomcmmssapui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=xom.com.cmms.sapui",
									"url": sap.ui.require.toUrl("xom/com/cmms/sapui")
								}
							}
						}
					}
